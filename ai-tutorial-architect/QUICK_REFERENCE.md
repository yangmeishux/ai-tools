...
| Agent | 角色 | 一句话描述 |
|-------|------|-----------|
| **Humanizer** | AI内容人性化师 | 去除AI写作痕迹，增加自然表达 |
...
→ [Humanizer 润色] → Version-Archivist 标注版本 → Fact-Checker 验证 → Chief 审核
```
...
| 去除AI味 | `[@humanizer] 让这段内容更自然，去除机器感` |
